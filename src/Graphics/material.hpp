...
public:
    ...
    explicit material(vengine* _vengine, const std::string& _name);

    void load_shader(const std::string& _shader_location);
    void add_texture(const std::string& _name, texture* _texture);
