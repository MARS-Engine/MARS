...
enum mars_buffer_type {
	...
	MARS_BUFFER_TYPE_SHADER_BINDING_TABLE = 1 << 10,
	MARS_BUFFER_TYPE_ACCELERATION_STRUCTURE_STORAGE = 1 << 11,
	MARS_BUFFER_TYPE_ACCELERATION_STRUCTURE_BUILD_INPUT = 1 << 12,
};
