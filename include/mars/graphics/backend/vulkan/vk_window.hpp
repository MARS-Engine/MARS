...
namespace mars {
    ...
    namespace graphics::vulkan {
        struct vk_window_impl {
            ...
            static void vk_window_get_instance_extensions(const window& _window, std::vector<const char*>& _extensions);
            static void vk_window_get_device_extensions(const window& _window, std::vector<const char*>& _extensions);
