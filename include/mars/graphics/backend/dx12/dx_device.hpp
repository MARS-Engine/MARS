...
struct dx_device_impl {
	...
	static void dx_device_submit_compute(const device& _device, const command_buffer& _command_buffer);
	static bool dx_device_supports_feature(const device& _device, device_feature _feature);
