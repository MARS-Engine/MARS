...
struct dx_descriptor_impl {
	...
	static descriptor_set dx_descriptor_set_create_rt(const descriptor& _descriptor, const device& _device, const ray_tracing_pipeline& _pipeline, const std::vector<descriptor_set_create_params>& _params);
	...
	static void dx_descriptor_set_bind_rt(const descriptor_set& _descriptor_set, const command_buffer& _command_buffer, const ray_tracing_pipeline& _pipeline, size_t _current_frame);
