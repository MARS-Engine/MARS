...
inline void render_pass_bind(const render_pass& _render_pass, const command_buffer& _command_buffer, const framebuffer& _framebuffer, const depth_buffer* _depth_buffer, const render_pass_bind_param& _params) {
	_render_pass.engine->get_impl<render_pass_impl>().render_pass_bind(_render_pass, _command_buffer, _framebuffer, _depth_buffer, _params);
}
