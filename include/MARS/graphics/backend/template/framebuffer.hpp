...
namespace mars_graphics {
    ...
    public:
        ...
        [[nodiscard]] inline std::shared_ptr<texture> get_texture(size_t _index) const { return _index < m_frames.size() ? m_frames[_index] : nullptr; }

        inline void set_depth(bool _enabled) { m_depth_enabled = _enabled; }
        inline std::shared_ptr<render_pass> get_render_pass() { return m_render_pass; }
